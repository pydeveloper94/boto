...
class Table(object):
    ...
    def update(self, throughput, global_indexes=None):
        ...
        if global_indexes:
            ...
            for gsi_name, gsi_throughput in six.iteritems(global_indexes):
                gsi_data.append({
                    "Update": {
                        "IndexName": gsi_name,
    ...
    def _build_filters(self, filter_kwargs, using=QUERY_OPERATORS):
        ...
        for field_and_op, value in six.iteritems(filter_kwargs):
    ...
    def _query(self, limit=None, index=None, reverse=False, consistent=False,
        ...
        if exclusive_start_key:
            ...
            for key, value in six.iteritems(exclusive_start_key):
        ...
        if raw_results.get('LastEvaluatedKey', None):
            ...
            for key, value in six.iteritems(raw_results['LastEvaluatedKey']):
    ...
    def _batch_get(self, keys, consistent=False):
        ...
        for key_data in keys:
            ...
            for key, value in six.iteritems(key_data):
                raw_key[key] = self._dynamizer.encode(value)
        ...
        for raw_key in raw_unproccessed.get('Keys', []):
            ...
            for key, value in six.iteritems(raw_key):
